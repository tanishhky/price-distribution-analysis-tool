...
from models import (
    ...
    OptionsChainRequest, OptionContractWithGreeks,
)
...
from volatility_engine import (
    ...
    generate_signals, generate_vol_summary,
)
...
async def volatility_analysis(req: VolatilityRequest):
    ...
    try:
        ...
        rv_10 = compute_realized_vol(req.candles, 10)
        rv_20 = compute_realized_vol(req.candles, 20)
        rv_30 = compute_realized_vol(req.candles, 30)
        rv_60 = compute_realized_vol(req.candles, 60)
        park_20 = compute_parkinson_vol(req.candles, 20)
        ...
        for contract in contracts:
            try:
                bar = await fetch_option_daily_bar(req.api_key, contract.ticker, yesterday)
